...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "formatDateImg": () => (/* binding */ formatDateImg)
/* harmony export */ });
...
const formatDateImg = (() => {
  ...
  function setGeneralDate(timeStamp) {
    ...
    const genDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(formatedDate, "EEEE dd MMM HH:mm O");
    return genDate;
  }

  function setFormattedTime(timeStamp) {
    let formatedDate = new Date(timeStamp * 1000);
    const timeSet = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(formatedDate, "HH:mm");
    return timeSet;
  }

  function setDay(timeStamp) {
    let formatedDate = new Date(timeStamp * 1000);
    const daySet = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(formatedDate, "EEEE");
    return daySet;
  }

  function setDateFormat(timeStamp) {
    let formatedDate = new Date(timeStamp * 1000);
    const dateSet = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(formatedDate, "dd MMM");
    return dateSet;
  }
...
/* harmony import */ var _dateImgFormat__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dateImgFormat */ "./src/modules/dateImgFormat.js");
...
const displayWeather = (() => {
  ...
  async function getCoords() {
    if (arguments.length == 1) {
      response = await _api__WEBPACK_IMPORTED_MODULE_0__.apiFunctions.getCurrLocationWeather(arguments[0]);
    } else {
      response = await _api__WEBPACK_IMPORTED_MODULE_0__.apiFunctions.getCurrLocationWeather();
    }
  ...
  async function getWeatherData() {
    ...
    response = await _api__WEBPACK_IMPORTED_MODULE_0__.apiFunctions.getSevenDayWeather(lat, lon);
    // console.log(response);
    displayData();
  }
  ...
  async function toggleTempUnit(unit) {
    ...
    response = await _api__WEBPACK_IMPORTED_MODULE_0__.apiFunctions.toggleTemp(unit, lat, lon);
    // console.log(response);
    displayData();
  }
  ...
  function displayData() {
    ...
    if (typeof response === "string") {
      ...
      currWeatherIcon.src = _dateImgFormat__WEBPACK_IMPORTED_MODULE_1__.formatDateImg.setLgImg(
        currentDayData.weather[0].icon
      );
      sunRise = _dateImgFormat__WEBPACK_IMPORTED_MODULE_1__.formatDateImg.setFormattedTime(currentDayData.sunrise);
      sunSet = _dateImgFormat__WEBPACK_IMPORTED_MODULE_1__.formatDateImg.setFormattedTime(currentDayData.sunset);

      dayDate = _dateImgFormat__WEBPACK_IMPORTED_MODULE_1__.formatDateImg.setGeneralDate(currentDayData.dt);
      ...
      data12Hrs.forEach((dataHr) => {
        ...
        hourDataImg.src = _dateImgFormat__WEBPACK_IMPORTED_MODULE_1__.formatDateImg.setSmImg(dataHr.weather[0].icon);

        hTemp = dataHr.temp;
        hTime = _dateImgFormat__WEBPACK_IMPORTED_MODULE_1__.formatDateImg.setFormattedTime(dataHr.dt);
      ...
      data8Days.forEach((dataDay) => {
        ...
        dayDataImg.src = _dateImgFormat__WEBPACK_IMPORTED_MODULE_1__.formatDateImg.setSmImg(dataDay.weather[0].icon);

        dDay = _dateImgFormat__WEBPACK_IMPORTED_MODULE_1__.formatDateImg.setDay(dataDay.dt);
        dDate = _dateImgFormat__WEBPACK_IMPORTED_MODULE_1__.formatDateImg.setDateFormat(dataDay.dt);
...
const formData = (() => {
  ...
  myForm.addEventListener("submit", (e) => {
    ...
    _dom__WEBPACK_IMPORTED_MODULE_0__.displayWeather.getWeatherData(locInput);
  });
  ...
  getTempUnits.forEach((unit) => {
    unit.addEventListener("click", () => {
      tempUnit = unit.value;
      // console.log(locInput);
      _dom__WEBPACK_IMPORTED_MODULE_0__.displayWeather.toggleTempUnit(tempUnit, locInput);
    });
  });
})();
